...
import hu.petrik.koblog.Adapters.VPAdapter;
...
public class VPActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnRight.setOnClickListener(v->{
            if (btnRight.getText().toString().equals("Következő")){
                viewPager.setCurrentItem(viewPager.getCurrentItem()+1);
            }
            else{
                startActivity(new Intent(VPActivity.this, AuthActivity.class));
                finish();
            }
        });
